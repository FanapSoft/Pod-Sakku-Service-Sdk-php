...
final class RemoveDomainTest extends TestCase
{
    ...
    public function setUp(): void
   {
	...
	public function testRemoveDomainAllParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'appId' => 2664,
		...
		try {
			$result = $SakkuService->removeDomain($params);
	...
	public function testRemoveDomainRequiredParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'appId' => 2664,
	...
	public function testRemoveDomainValidationError()
	{
		...
		try {
			self::$SakkuService->removeDomain($paramsWithoutRequired);
		} catch (ValidationException $e) {
		...
		try {
			self::$SakkuService->removeDomain($paramsWrongValue);
		} catch (ValidationException $e) {
