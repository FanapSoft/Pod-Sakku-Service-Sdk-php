...
final class StopAppDeployTest extends TestCase
{
    ...
    public function setUp(): void
   {
	...
	public function testStopAppDeployAllParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'appId' => 1234,
		...
		try {
			$result = $SakkuService->stopAppDeploy($params);
	...
	public function testStopAppDeployRequiredParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'appId' => 1234,
	...
	public function testStopAppDeployValidationError()
	{
		...
		try {
			self::$SakkuService->stopAppDeploy($paramsWithoutRequired);
		} catch (ValidationException $e) {
		...
		try {
			self::$SakkuService->stopAppDeploy($paramsWrongValue);
		} catch (ValidationException $e) {
