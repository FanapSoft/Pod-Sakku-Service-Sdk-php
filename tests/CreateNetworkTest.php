...
final class CreateNetworkTest extends TestCase
{
    ...
    public function setUp(): void
   {
	...
	public function testCreateNetworkAllParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'name' => uniqid('net_'),
		...
		try {
			$result = $SakkuService->createNetwork($params);
	...
	public function testCreateNetworkRequiredParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'name' => uniqid('net_'),
	...
	public function testCreateNetworkValidationError()
	{
		...
		try {
			self::$SakkuService->createNetwork($paramsWithoutRequired);
		} catch (ValidationException $e) {
		...
		try {
			self::$SakkuService->createNetwork($paramsWrongValue);
		} catch (ValidationException $e) {
