...
final class GetAppDomainsTest extends TestCase
{
    ...
    public function setUp(): void
   {
	...
	public function testGetAppDomainsAllParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'appId' => 2664,
		...
		try {
			$result = $SakkuService->getAppDomains($params);
	...
	public function testGetAppDomainsRequiredParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'appId' => 2664,
	...
	public function testGetAppDomainsValidationError()
	{
		...
		try {
			self::$SakkuService->getAppDomains($paramsWithoutRequired);
		} catch (ValidationException $e) {
		...
		try {
			self::$SakkuService->getAppDomains($paramsWrongValue);
		} catch (ValidationException $e) {
